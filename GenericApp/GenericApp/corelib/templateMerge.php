...
/**
 * templateMerge is used to merge data, typically fragments if HTML, into a template
 * to generate a full HTML page. The template is an HTML file, with some extra tags
 * added to indicate where template data is to be inserted.
 */
class templateMerge
{
    var $fields;
    ...
    /**
     * Creates an instance of a templateMerge class, and loads the template.
     * @param string $templateFile is the path to the HTML template file.
     */
    ...
    /**
     * Adds a script to the template, to be included at the location of the < %scripts%> placeholder tag.
     * Scripts will be included in the page in the order they are added using this method. 
     * @param string $path The path to the script file (relative to page root.)
     */
    ...
    private function sectionRender(&$i)
    {
        $fieldinfo = $this->fields[$i]['value'];
        $out = '';
        $params = $this->fields[$i]['params'];
